...
namespace VStorm.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IContextProvider<ContactsContext>>().To<ContactsProvider>().InSingletonScope();
            kernel.Bind<IValuesProvider>().To<ValuesProvider>().InSingletonScope();
        }        
    }
}
